  ...
  return (
    <section id="about-me" className="py-8 md:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex items-center mb-6 md:mb-12 flex-wrap sm:flex-nowrap">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
          ...
          <div className="relative mt-6 md:mt-0">
            ...
            <div className="w-full h-[250px] xs:h-[280px] sm:h-[350px] md:h-[400px] relative border border-[#c778dd] rounded-md overflow-hidden bg-[#282c33] flex items-center justify-center">
              <div className="text-center px-4">
                <div className="text-lg xs:text-xl sm:text-2xl font-fira-code text-[#c778dd]">{'<developer/>'}</div>
                <div className="text-base xs:text-lg sm:text-xl font-fira-code mt-2 text-white"></div>
              </div>
            </div>
